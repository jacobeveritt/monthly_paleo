...
##JEveritt changed colorout to colorspace
require(colorspace)
require(assertthat)
...
cc_event_2000 <- subset(drought_event_summary, year(drought_event_summary$begin) >1999 & year(drought_event_summary$begin) < 2001 & data!="observed" & data!="paleo"& data!="CTN5")
"test_subset replaced with drought_event_summary"
